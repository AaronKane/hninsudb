...
function NinjaSlider(a) {
  ...
  var Gb = function(a) {
    ...
    S = function() {
      ...
      m(" div.fs-icon{cursor:pointer;position:absolute;z-index:99999;}");
      m(".fullscreen div.fs-icon{position:fixed;top:6px;right:6px;}");
  ...
  var eb = function(l) {
    ...
    nb = function(a) {
      ib.innerHTML = hb.innerHTML = "<div>" + (a + 1) + " &#8725; " + x + "</div>";
      if (t[d]) {
        var b = t[d];
        while (b--) t[b][i] = "";
        t[a][i] = "active"
  ...
  eb.prototype = {
    ...
    addNavs: function() {
      ...
      hb = this.e("-next", function() {
        j(c + 1, 1)
      });
      Q = this.e("-pause-play", G);
      Q[i] = "paused";
